...
public partial class BookManagementDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C207D4AFB879");
        ...
        {
            entity.HasKey(e => e.BookCategoryId).HasName("PK__BookCate__6347EC0405EB28EE");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__UserAcco__0CF04B1898FCCEC5");
